...
# Public-safe defaults used only by tests that exercise optional publishing.
# Production code keeps these values empty until the user configures them.
os.environ.setdefault("WEB_STUDIO_PROJECT", "test-project")
os.environ.setdefault("WEB_STUDIO_SITE", "test-site")
os.environ.setdefault("WEB_STUDIO_PUBLIC_ORIGIN", "https://test.invalid")
