...
Make QQ `1211000567` able to request complete, high-quality local Agent tasks, including public GitHub research and Word document delivery, while keeping system security, credentials, private data, and irreversible external actions protected.
...
- Trusted Pro is a machine-local immutable allowlist containing only `1211000567`.
