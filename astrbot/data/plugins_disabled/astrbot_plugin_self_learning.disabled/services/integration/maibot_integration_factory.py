...
class MaiBotIntegrationFactory:
    ...
    def __init__(self, config: PluginConfig = None, db_manager: DatabaseManager = None, context=None, llm_adapter=None):
        ...
        if config and db_manager:
            ...
            # 创建记忆管理器
            from ..state.enhanced_memory_graph_manager import EnhancedMemoryGraphManager
            self.memory_manager = EnhancedMemoryGraphManager.get_instance(
                config, db_manager, llm_adapter,
