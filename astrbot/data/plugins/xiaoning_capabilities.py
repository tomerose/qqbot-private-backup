...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("search", "search_command", ("ordinary", "x", "pro"), ("查资料", "搜索", "帮我搜", "最新", "哪里", "路线", "推荐"), "帮我查一下今天的 AI 新闻", "/search", "这个我能查清楚；把范围、地点或筛选条件补一句就行。", proactive=True),
    ...
    Capability("draw", "draw_command", ("ordinary", "x", "pro"), ("画图", "作图", "绘图", "画一幅", "海报", "头像", "图片"), "帮我画一只雨夜霓虹下的黑猫", "/draw", "这个我能直接画；把主体、风格和画幅说清楚就行。", (".png", ".jpg", ".webp"), True),
    ...
    Capability("video_generate", "video_command", ("x", "pro"), ("生成视频", "AI视频", "Veo", "生成短片", "生成动画", "短动画"), "帮我生成一段海边日落短片", "/video", "这个我能生成原创 AI 视频文件；说清画面、比例和节奏就行。", (".mp4", ".gif"), True),
    ...
    Capability("web", "web_studio", ("x", "pro"), ("做网页", "制作网页", "记账网页", "网站", "网页工坊"), "帮我做一个记账网页", "/web", "这个我能做成可操作网页，并返回预览、HTML 和公开链接。", (".html",), True),
    ...
    Capability("link_summary", "link_summary", ("ordinary", "x", "pro"), ("总结链接", "网页总结", "这篇文章", "公开链接"), "总结一下这个公开链接", "/summary", "这个我能读取公开页面并提炼重点。", proactive=True),
    Capability("github", "github_tools", ("ordinary", "x", "pro"), ("GitHub", "开源项目", "仓库"), "帮我找 GitHub 上优秀的语音项目", "/gh", "这个我能查 GitHub 仓库并整理重点。", proactive=True),
    Capability("debate", "ai_debate", ("x", "pro"), ("圆桌辩论", "圆桌讨论", "AI辩论", "多方观点"), "圆桌讨论 AI 会不会降低人的能力", "/debate", "这个适合让多个角色从不同立场讨论。", proactive=True),
    Capability("interview", "ai_interview", ("x", "pro"), ("模拟面试", "面试练习", "练习面试"), "帮我模拟产品经理面试", "/interview", "这个我能按真实面试连续追问并给反馈。", proactive=True),
